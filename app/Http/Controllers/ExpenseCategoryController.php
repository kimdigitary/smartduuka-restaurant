...
class ExpenseCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        })->with('parent_category')->where('user_id', $this->id())->get();
    ...
    {
        try {
//            ProductCategory::tree()->depthFirst()->with('parent_category', 'media', 'products')->where('user_id', $this->id())->get();
            return ProductCategoryDepthTreeResource::collection(ExpenseCategory::tree()->depthFirst()->with('parent_category')->where('user_id', $this->id())->get());
//            return ProductCategoryDepthTreeResource::collection(ExpenseCategory::tree()->depthFirst()->get());
//            $this->response(success: true, message: 'success', data: $data);
