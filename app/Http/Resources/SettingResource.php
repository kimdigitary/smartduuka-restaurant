...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $data = [
            ...
            'theme_logo' => $this->themeImage('theme_logo')?->logo ?? '/images/theme/theme-logo.png',
            'theme_footer_logo' => $this->themeImage('theme_footer_logo')?->footerLogo ?? '/images/theme/theme-footer-logo.png',
            'theme_favicon_logo' => $this->themeImage('theme_favicon_logo')?->faviconLogo ?? '/images/theme/theme-favicon-logo.png',
            ...
            'no_kitchen_orders' => asset('/images/kitchen.png'),
    ...
    {
        $tenantId = TenantUser::where('user_id', \Auth::user()->id)->first()->tenant_id;

        \Log::info("Tenant at resource: " . $tenantId);
        return ThemeSetting::where('key', $key)
