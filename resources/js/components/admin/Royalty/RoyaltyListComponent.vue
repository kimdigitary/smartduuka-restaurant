    ...
    <div class="db-card db-tab-div active">
        <div class="db-card-header border-none">
            ...
            <div class="db-card-filter">
                ...
                <RoyaltyCreateComponent :props="props"/>
            </div>
        </div>
...
export default {
    ...
    computed: {
        royaltyPackages: function () {
            return this.$store.getters['royalty/lists'];
        },
        pagination: function () {
            return this.$store.getters['royalty/pagination'];
        },
        paginationPage: function () {
            return this.$store.getters['royalty/page'];
        }
    },
    mounted() {
        this.list();
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch('royalty/lists', this.props.search).then(res => {
        ...
        edit: function (productCategory) {
            ...
            this.loading.isActive = true;
            this.$store.dispatch('royalty/edit', productCategory.id);
            this.props.form = {
        ...
        destroy: function (id) {
            appService.destroyConfirmation().then((res) => {
                try {
                    this.loading.isActive = true;
                    this.$store.dispatch('royalty/destroy', {id: id, search: this.props.search}).then((res) => {
                        this.loading.isActive = false;
