    ...
    <div id="modal" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">Benefit</h3>
...
export default {
    name: "RoyaltyBenefitsCreateComponent",
    ...
    methods: {
        reset: function () {
            ...
            this.$store.dispatch('benefits/reset').then().catch();
            this.errors = {};
        ...
        save: function () {
            try {
                ...
                const tempId = this.$store.getters['benefits/temp'].temp_id;
                this.loading.isActive = true;
                this.$store.dispatch('benefits/save', {
                    form: fd,
                    search: this.props.search
                }).then((res) => {
                    appService.modalHide();
                    this.loading.isActive = false;
                    alertService.successFlip((tempId === null ? 0 : 1), 'Benefit added');
                    this.props.form = {
                        name: "",
                        description: "",
                        status: statusEnum.ACTIVE,
