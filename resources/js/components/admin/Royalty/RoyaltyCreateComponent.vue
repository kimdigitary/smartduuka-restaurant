    ...
    <div id="modal" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">Add Membership Tier</h3>
...
export default {
    ...
    methods: {
        reset: function () {
            ...
            this.$store.dispatch('royalty/reset').then().catch();
            this.errors = {};
        ...
        save: function () {
            try {
                ...
                const tempId = this.$store.getters['royalty/temp'].temp_id;
                this.loading.isActive = true;
                this.$store.dispatch('royalty/save', {
                    form: fd,
                    search: this.props.search
                }).then((res) => {
                    appService.modalHide();
                    this.loading.isActive = false;
                    alertService.successFlip((tempId === null ? 0 : 1), 'Package added');
                    this.props.form = {
                        name: "",
                        description: "",
                        status: statusEnum.ACTIVE,
