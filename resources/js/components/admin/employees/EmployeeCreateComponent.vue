                ...
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <div class="relative">
                            <input v-model="props.form.password" v-bind:class="errors.password ? 'invalid' : ''"
                                   type="password"
                                   id="password" class="db-field-control absolute" autocomplete="off"/>
                            <span class="right-0 w-8 h-8"> <i class="lab lab-view absolute w-full cursor-pointer"></i></span>
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <div class="relative bg-violet-950">
                            <input
                                ...
                                class="db-field-control absolute"
                                autocomplete="off"
                            />
                            <i class="lab lab-view absolute right-10"></i>
                        </div>
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <vue-select class="db-field-control f-b-custom-select" id="role_id"
                                    v-bind:class="errors.role_id ? 'invalid' : ''" v-model="props.form.role_id"
                                    :options="roles"
