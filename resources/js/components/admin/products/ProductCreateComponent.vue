                ...
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <vue-select class="db-field-control f-b-custom-select" id="product_brand_id"
                            v-bind:class="errors.product_brand_id ? 'invalid' : ''" v-model="props.form.product_brand_id"
                            :options="productBrands" label-by="name" value-by="id" :closeOnSelect="true" :searchable="true"
                            :clearOnClose="true" placeholder="--" search-placeholder="--" />
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <vue-select class="db-field-control f-b-custom-select" id="unit_id"
                            ...
                            label-by="name_code" value-by="id" :closeOnSelect="true" :searchable="true" :clearOnClose="true"
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-model="props.form.weight" v-bind:class="errors.weight ? 'invalid' : ''" type="text" id="weight" class="db-field-control">
                    ...
                    <div class="form-col-12 sm:form-col-12">
                        ...
                        <div>
                            <vue-tags-input id="tags" v-bind:class="errors.tags ? 'invalid-tag' : ''" placeholder=""
                                v-model="tag" :tags="props.form.convertTags" @tags-changed="newTags => props.form.convertTags = newTags" />
                        </div>
...
export default {
    ...
    data() {
        return {
            ...
            addButton: {
                title: this.$t("button.add_product")
            },
            enums: {
