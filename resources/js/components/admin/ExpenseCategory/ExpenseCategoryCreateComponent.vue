                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <vue-select class="db-field-control f-b-custom-select" id="parent_category"
                                        ...
                                        :options="expenseCategoryDepthTrees" label-by="option" value-by="id" :closeOnSelect="true"
                        ...
                        <div class="form-col-12 sm:form-col-12">
                            ...
                            <small class="db-field-alert" v-if="errors.image">{{ errors.image }}</small>
                        </div>
...
export default {
    ...
    computed: {
        expenseCategoryDepthTrees: function () {
            return this.$store.getters['expenseCategory/depthTrees'];
        },
    },
    mounted() {
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                const tempId = this.$store.getters['expenseCategory/temp'].temp_id;
                this.loading.isActive = true;
                this.$store.dispatch('expenseCategory/save', {
                    form: fd,
