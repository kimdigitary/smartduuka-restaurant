...
export default {
    ...
    computed: {
        addresses: function () {
            return this.$store.getters["administratorAddress/lists"];
        },
        pagination: function () {
            return this.$store.getters["administratorAddress/pagination"];
        },
        paginationPage: function () {
            return this.$store.getters["administratorAddress/page"];
        },
    },
    methods: {
        list: function (page = 1) {
            ...
            this.$store.dispatch("administratorAddress/lists", {
                id: this.props,
        ...
        destroy: function (addressId) {
            appService.destroyConfirmation().then((res) => {
                try {
                    this.loading.isActive = true;
                    this.$store.dispatch("administratorAddress/destroy", {
                        id: this.props,
                        addressId: addressId,
                        search: this.address.search
                    }).then((res) => {
