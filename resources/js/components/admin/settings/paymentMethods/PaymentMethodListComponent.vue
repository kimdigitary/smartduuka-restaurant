            ...
            <table class="db-table stripe">
                <thead class="db-table-head">
                    <tr class="db-table-head-tr">
                        ...
                        <th class="db-table-head-th">Merchant code / Phone Number</th>
                ...
                <tbody class="db-table-body" v-if="analytics.length > 0">
                    <tr class="db-table-body-tr" v-for="analytic in analytics" :key="analytic">
                        ...
                        <td class="db-table-body-td">{{ analytic.merchant_code }}</td>
...
import AnalyticCreateComponent from "../analytics/AnalyticCreateComponent.vue";
...
import PaymentMethodCreateComponent from "./PaymentMethodCreateComponent.vue";
...
export default {
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch('analytic/paymentLists', this.props.search).then(res => {
        ...
        destroy: function (id) {
            appService.destroyConfirmation().then((res) => {
                try {
                    this.loading.isActive = true;
                    this.$store.dispatch('analytic/paymentMethodDestroy', { id: id, search: this.props.search }).then((res) => {
                        this.loading.isActive = false;
