        ...
        <div class="db-card-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="site_food_preparation_time" class="db-field-title required">
                            {{ $t("label.food_preparation_time") }}
                            <span class="text-primary">{{ $t("label.in_minute") }}</span>
                        </label>
                        <input v-on:keypress="floatNumber($event)" v-model="form.site_food_preparation_time"
                            v-bind:class="errors.site_food_preparation_time ? 'invalid' : ''" type="text"
                            id="site_food_preparation_time" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.site_food_preparation_time">{{
