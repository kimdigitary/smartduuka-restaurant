                            ...
                            <div class="db-field-radio-group">
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.statusEnum.ACTIVE" v-model="props.form.status"
                                            id="extraActive" type="radio" class="custom-radio-field" />
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.statusEnum.INACTIVE" v-model="props.form.status"
                                            type="radio" id="extraInactive" class="custom-radio-field" />
                                        <span class="custom-radio-span"></span>
                                    </div>
