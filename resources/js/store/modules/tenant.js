    ...
    actions: {
        ...
        save: function (context, payload) {
            ...
            return new Promise((resolve, reject) => {
                ...
                let url = "/admin/setting/tenant";
                if (this.state["tenant"].temp.isEditing) {
                    method = axios.post;
                    url = `/admin/setting/tenant/update/${this.state["tenant"].temp.temp_id}`;
                }
        ...
        destroy: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .delete(`admin/setting/tenant/${payload.id}`)
                    .then((res) => {
                        context
        ...
        show: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .get(`admin/setting/tenant/show/${payload}`)
                    .then((res) => {
                    ...
                    .catch((err) => {
                        console.error("Error fetching tenant:", err.response ? err.response.data : err);
                        reject(err);
                    });
            });
        },
        fileList: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = `/admin/setting/tenant/file-list/${payload}`;
        ...
        fileText: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = `/admin/setting/tenant/file-text`;
        ...
        fileStore: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = `/admin/setting/tenant/file-text/store`;
                axios.post(url, payload).then((res) => {
